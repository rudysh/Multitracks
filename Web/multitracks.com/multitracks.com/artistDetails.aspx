                ...
                <main class="discovery--section">
                    ...
                    <section class="standard--holder">
                        <div class="discovery--section--header">
                            <h2>Top Songs</h2>
                            <a class="discovery--section--header--view-all" id="allSongs" runat="server" href="#">View All</a>
                        </div>
                        <!-- /.discovery-select -->
                                    ...
                                    <li class="song-list--item media-player--row">
                                        ...
                                        <div class="song-list--item--right">
                                            ...
                                            <div class="song-list--item--icon--holder">
                                                <div runat="server" visible='<%#(bool) Eval("MultiTracks")  %>'>
                                                ...
                                                <div runat="server" visible='<%#(bool) Eval("CustomMix")  %>'>
                                                    <a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
                                                ...
                                                <div runat="server" visible='<%#(bool) Eval("RehearsalMix")  %>'>
                                                    <a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
                                                ...
                                                <div runat="server" visible='<%#(bool) Eval("Patches")  %>'>
                                                    <a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
                                                ...
                                                <div runat="server" visible='<%#(bool) Eval("ChordChart")  %>'>
                                                    <a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
                                                ...
                                                <div runat="server" visible='<%#(bool) Eval("ProPresenter")  %>'>
                                                    <a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
                    ...
                    <div class="discovery--space-saver">
                        <section class="standard--holder">
                            <div class="discovery--section--header">
                                <h2>Albums</h2>
                                <a class="discovery--section--header--view-all" id="allAlbums" runat="server" href="#">View All</a>
                            </div>
                            <!-- /.discovery-select -->
